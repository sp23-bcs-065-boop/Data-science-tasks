...
> 
  ...
  > boxplot(mpg ~ cyl, data = mtcars,
            +         main = "Distribution of Miles per Gallon Across Cylinder Categories",
...
> 
  ...
  > hist(mtcars$wt,
         +      breaks = 8,  # customize the number of bins
         ...
         +      border = "black")
> 
  > pdf("boxplot_mpg_cyl.pdf", width = 7, height = 5)
> boxplot(mpg ~ cyl, data = mtcars,
          +         main = "MPG Distribution Across Cylinders",
...
> 
  ...
  > pdf("car_weights_histogram.pdf", width = 7, height = 5)
> 
  > hist(mtcars$wt,
         +      breaks = 8,
         +      main = "Distribution of Car Weights",
